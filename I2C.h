...
extern void I2C_write(unsigned char slaveadd,unsigned char add,unsigned char data);
extern void I2C_read(unsigned char slaveadd,unsigned char regadd,unsigned char len,unsigned char* ramadd);
